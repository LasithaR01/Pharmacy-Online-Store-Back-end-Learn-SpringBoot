...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        List<Tag> tags = Arrays.asList(
                new Tag().name("Authentication").extensions(java.util.Map.of("x-order", 17)),
                new Tag().name("User Management").extensions(java.util.Map.of("x-order", 16)),
                ...
                new Tag().name("Employee Management").extensions(java.util.Map.of("x-order", 15))
        );
